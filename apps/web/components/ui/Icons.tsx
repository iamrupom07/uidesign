...
export function IconPetrochem({ className = "w-6 h-6" }: IconProps) {
  return (
    ...
    >
      <path
        d="M9 2h6M10 2v5l-4.5 8.5A3 3 0 0 0 8.1 20h7.8a3 3 0 0 0 2.6-4.5L14 7V2"
        strokeLinecap="round"
...
export function IconLime({ className = "w-6 h-6" }: IconProps) {
  return (
    ...
    >
      <path
        d="M12 3c3 3 5 6.2 5 9.5A5 5 0 0 1 7 12.5C7 9.2 9 6 12 3z"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
export function IconTailing({ className = "w-6 h-6" }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M4 16c0-5 2-8 4-8s3 3 3 5 1 3 3 3 3-4 5-4 2 2 2 4"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
export function IconDesignSupport({ className = "w-6 h-6" }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M13 6l2.5-2.5a1.8 1.8 0 0 1 2.5 0l2 2a1.8 1.8 0 0 1 0 2.5L17.5 10.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
