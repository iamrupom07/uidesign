    ...
    <section className="bg-white py-24 px-4 sm:px-6 lg:px-8 overflow-hidden blueprint-mesh relative">
      ...
      <div className="absolute top-8 left-8 right-8 bottom-8 border border-slate-200/55 pointer-events-none select-none hidden md:block">
        <div className="absolute top-2 left-3 font-mono text-[8px] text-slate-400/80 tracking-widest uppercase">
          DRAFTING DOSSIER / SHEET 01 / REV.A
        </div>
        <div className="absolute bottom-2 right-3 font-mono text-[8px] text-slate-400/80 tracking-widest uppercase">
          MACPROTEC / Houston, TX
        </div>
      </div>
            ...
            <Reveal delay={0.24}>
              <div className="mt-10 flex flex-wrap gap-sm">
                <Magnetic strength={0.05}>
                  <Link href="/lets-connect" className="button-primary inline-block text-center">
                    Book Consultation
                  </Link>
                </Magnetic>
                <Magnetic strength={0.05}>
                  <Link href="#our-services" className="button-outline inline-block text-center">
                    Explore Services
                  </Link>
                </Magnetic>
              </div>
