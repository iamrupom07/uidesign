        ...
        >
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div
                className="absolute top-4 right-4 font-mono text-[8px] text-slate-400 notranslate"
                translate="no"
              >
              ...
              <div className="flex items-center gap-2 justify-center md:justify-start">
                ...
                <p
                  className="font-sans font-extrabold text-4xl sm:text-5xl text-foreground tracking-tight notranslate"
                  translate="no"
                >
