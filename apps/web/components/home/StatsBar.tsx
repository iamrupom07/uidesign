          ...
          {stats.map((stat, i) => {
            ...
            return (
              <RevealItem key={stat.label}>
                <div className="bg-white border border-slate-200 p-8 relative rounded-none shadow-sm hover:shadow-xl hover:border-primary/60 transition-all duration-300 flex flex-col justify-between h-full group overflow-hidden">
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div className="inline-flex items-center gap-1.5 bg-rose-50 border border-rose-200/80 px-2.5 py-1 font-mono text-[10px] font-extrabold text-primary tracking-widest uppercase">
                  ...
                  {/* Footer Indicator */}
                  <div className="mt-8 pt-4 border-t border-slate-100 font-mono text-[10px] font-bold text-slate-400 uppercase tracking-wider flex items-center justify-between group-hover:text-slate-600 transition-colors">
