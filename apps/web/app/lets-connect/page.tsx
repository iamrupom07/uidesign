              ...
              <Reveal>
                ...
                >
                  ...
                  <Magnetic strength={0.05}>
                    <button type="submit" className="button-primary px-8 py-3 text-xs uppercase">
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8">
          <Reveal className="mb-6">
            ...
            <p className="text-xs text-secondary max-w-xl">
              Select an available time slot below to calendar a virtual design and flowsheet audit
              review with our process team.
            </p>
          </Reveal>
              ...
              <div className="bg-white border border-border p-6 rounded-none">
                <div className="flex justify-between items-center mb-6 border-b border-border pb-4">
                  ...
                  <div className="flex gap-2">
                    <button className="p-1.5 border border-border hover:bg-slate-50 text-[10px] font-bold font-mono">
                      ‹
                    </button>
                    <button className="p-1.5 border border-border hover:bg-slate-50 text-[10px] font-bold font-mono">
                      ›
                ...
                {selectedTime && (
                  <div className="mt-6">
                    ...
                    <button
                      onClick={() =>
                        alert(
                          `Review scheduled for ${selectedDate} at ${selectedTime}. Confirmation email sent.`
                        )
                      }
