...
import { STEEL_SERVICES, SteelService } from "@/lib/steel-data";
import {
  ArrowRight,
  CheckCircle2,
  Cpu,
...
const WHY_CHOOSE_SIMULATION = [
  {
    title: "Deep Steel Industry Domain Expertise",
    desc: "Specialized thermal and fluid dynamics engineers with extensive experience across Blast Furnaces, BOF/EAF converters, reheating furnaces, and gas cleaning plants.",
    icon: Factory,
  },
  {
    title: "Advanced Multiphase & Combustion Physics",
    desc: "High-fidelity modeling of complex gas-solid flows, pulverised coal injection, flame stability, chemical reaction, and radiation heat transfer.",
    icon: Flame,
  },
  {
    title: "Zero Shutdown Virtual Validation",
    desc: "Test performance modifications, duct redesigns, and burner upgrades in a virtual CFD environment without risking physical plant downtime.",
    icon: Cpu,
  },
  {
    title: "Actionable Engineering Deliverables",
    desc: "Clear visual contour maps, velocity vectors, pressure drop reports, and precise CAD-ready design recommendations for your engineering team.",
    icon: FileText,
  },
  {
    title: "Energy & Emissions Optimization",
    desc: "Target fan power reduction, heat recovery optimization, and lower CO/NOx emissions to comply with stringent environmental standards.",
    icon: Zap,
  },
  {
    title: "Proven Debottlenecking Track Record",
    desc: "Consistently resolving flow imbalance, furnace hot spots, baghouse filter loading, and pipeline erosion in major steelmaking facilities worldwide.",
    icon: Award,
  },
];

export default function SteelCfdPage() {
  const [activeServiceId, setActiveServiceId] = useState<string>("01");

  const activeService =
    STEEL_SERVICES.find((s) => s.id === activeServiceId) || STEEL_SERVICES[0];
    ...
    <>
      ...
      <main className="bg-background min-h-screen py-20 lg:py-24 space-y-20">
          ...
          <div className="border border-border p-8 sm:p-12 lg:p-16 bg-white relative overflow-hidden shadow-sm">
            ...
            <Reveal>
              <div className="font-mono text-[11px] font-bold text-primary tracking-widest uppercase mb-4 flex items-center gap-2">
                ...
                <span>/</span>
                <span className="text-foreground">STEEL INDUSTRY</span>
              </div>
              ...
              <p className="body-md text-secondary max-w-4xl leading-relaxed font-sans mb-8">
                ...
                combustion, multiphase gas-solid flow, dust collection, fume extraction, and root cause investigation
                tailored specifically to steel plant gas systems, furnaces, gas cleaning plants, and bulk material handling.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4 border-t border-border">
                ...
                >
                  <span>Explore 10 Engineering Services</span>
          ...
          <Reveal>
            <div className="bg-[#2d1b47] text-white p-6 sm:p-8 border border-[#3e2663] relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
              ...
              <div className="shrink-0 font-mono text-xs text-slate-300 bg-[#201235] px-4 py-2 border border-[#3e2663]">
                <span className="text-primary font-bold">10</span> SPECIALIZED MODULES
              </div>
            </div>
          </Reveal>
        </section>
        ...
        <section id="service-cards" className="max-w-7xl mx-auto px-6 lg:px-8 space-y-8">
          <Reveal>
            <div className="font-mono text-[11px] font-bold text-primary tracking-widest uppercase mb-2">
              <span className="text-primary font-bold mr-1">┌</span> APPLIED STEEL ENGINEERING SERVICES
            </div>
                  ...
                  <div className="border border-border p-2 bg-slate-50 relative group">
                    <div className="relative h-64 sm:h-72 w-full bg-slate-900 overflow-hidden border border-border">
                      ...
                      <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between font-mono text-[9px] text-white bg-slate-950/80 p-2 border border-slate-800 backdrop-blur-sm">
                        <span>MODEL: MACPROTEC-STEEL-{activeService.id}</span>
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 space-y-8">
          <Reveal>
            <div className="font-mono text-[11px] font-bold text-primary tracking-widest uppercase mb-2">
              <span className="text-primary font-bold mr-1">┌</span> STEEL PLANT MODULES
            </div>
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-foreground uppercase tracking-tight">
              Steel Plant Equipment <span className="text-primary">Applications</span>
            </h2>
            <p className="font-mono text-sm font-semibold text-secondary max-w-3xl mt-2">
          ...
          <RevealGroup className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6" stagger={0.04}>
            {[
              {
                title: "Blast Furnace (BF) & Stove Systems",
                desc: "BF off-gas flow distribution, hot blast stove gas balance, tuyere combustion, and burden gas permeability.",
                tag: "PRIMARY IRONMAKING",
              },
              {
                title: "Basic Oxygen Furnace (BOF) Systems",
                desc: "Converter off-gas hood cooling, secondary fume extraction, suppressed combustion systems, and slag splash gas dynamics.",
                tag: "STEELMAKING",
              },
              {
                title: "Electric Arc Furnace (EAF) Fume Capture",
                desc: "Fourth-hole evacuation (DEC), canopy hood primary/secondary fume capture, oxy-fuel burner flame simulation, and slag door ventilation.",
                tag: "EAF OPERATIONS",
              },
              {
                title: "Reheating & Annealing Furnaces",
                desc: "Walking beam burner placement, combustion efficiency, oxygen concentration, slab thermal uniformity, and scale formation mitigation.",
                tag: "ROLLING & REHEATING",
              },
              {
                title: "Continuous Casting Cooling Systems",
                desc: "Secondary cooling spray mist CFD, tundish/ladle thermal fluid dynamics, liquid steel flow distribution, and refractory thermal stress.",
                tag: "CASTING",
              },
              {
                title: "Baghouses & ESP Dust Collectors",
                desc: "Gas distribution plates, filter bag velocity uniformity, dust hopper deposition, and differential pressure minimization.",
                tag: "DUST CONTROL",
              },
              {
                title: "PCI & Pneumatic Material Conveying",
                desc: "Pulverized Coal Injection line splitting balance, iron ore/lime fines conveying, pipeline elbow wear prediction, and blockage prevention.",
                tag: "BULK CONVEYING",
              },
              {
                title: "Waste Heat Recovery (WHR) Ducts",
                desc: "Waste heat boiler flow balancing, particulate erosion mapping, heat exchanger efficiency enhancement, and pressure loss tuning.",
                tag: "ENERGY RECOVERY",
              },
              {
                title: "Cast House & Workshop Ventilation",
                desc: "Blast furnace cast house canopy ventilation, toxic fume dispersion modeling, heat stress reduction, and indoor air quality compliance.",
                tag: "PLANT VENTILATION",
              },
            ].map((app, idx) => (
              <RevealItem key={idx}>
        ...
        {/* WHY CHOOSE MACPROTEC FOR SIMULATION? (Page 20 Requirement) */}
            ...
            <div className="bg-slate-900 text-white p-10 sm:p-14 border border-slate-800 relative overflow-hidden shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="max-w-2xl">
                ...
                <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-white uppercase tracking-tight leading-tight">
                  Optimize Your Steel Plant Operations <br />
