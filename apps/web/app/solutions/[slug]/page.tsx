...
export default function SolutionDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const solutionsData: Record<string, SolutionContent> = {
    "cfd-engineering": {
      ...
      subtitle:
        "Optimize fluid velocities, multi-phase thermodynamics, and combustion lines mathematically.",
      features: [
        {
      ...
      comparisonLeftDesc:
        "Combustion profiling maps spatial temperature envelopes to minimize emissions and prevent flame impingement on refractories.",
    ...
    "process-simulation": {
      ...
      subtitle:
        "Construct dynamic transient simulation models for Virtual Commissioning and telemetry feedback.",
      features: [
        {
      ...
      lifecycleSteps: [
        {
          step: "01",
          label: "Flowsheet Setup",
          desc: "Map unit operations, process blocks, and stream connections.",
        },
        {
          step: "02",
          label: "Thermodynamic Tuning",
          desc: "Select and validate equations of state (PR, NRTL) against fluid behavior.",
        },
        {
          step: "03",
          label: "Transient Checkout",
          desc: "Insert dynamic valve parameters and controller algorithms.",
        },
        {
          step: "04",
          label: "Twin Twin Setup",
          desc: "Synchronize model tags with plant SCADA variables.",
        },
      ],
      comparisonLeftTitle: "Dynamic Simulation Details",
      comparisonLeftDesc:
        "Dynamic transient flows forecast surge risks in compressor grids and water-hammer impacts in process pipes.",
  ...
  const defaultData: SolutionContent = {
    title: slug
      ...
      .join(" "),
    subtitle:
      "High-precision process engineering and validation consulting tailored for heavy process plants.",
    features: [
      {
    ...
    lifecycleDesc:
      "Every project follows our validated engineering steps to ensure zero errors on fabrication.",
    lifecycleSteps: [
      {
        step: "Phase 1",
        label: "Data Capture",
        desc: "Laser scanning and sensor telemetry audits.",
      },
      {
        step: "Phase 2",
        label: "FEED Layout",
        desc: "Detailed drafting design and stress checks.",
      },
      {
        step: "Phase 3",
        label: "Verification",
        desc: "Mathematical optimization and simulation solver checkouts.",
      },
      {
        step: "Phase 4",
        label: "Validation",
        desc: "Site commissioning and SLA performance logs.",
      },
    ],
    comparisonLeftTitle: "Continuous Operations",
    comparisonLeftDesc:
      "Continuous process optimization ensures material tolerances and combustion configurations remain at peak efficiency.",
      ...
      <main className="bg-background min-h-screen blueprint-mesh space-y-24 pt-24 pb-20">
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 border-t border-border pt-20">
          <Reveal className="mb-12">
            ...
            <p className="text-xs text-secondary mt-2">{content.lifecycleDesc}</p>
          </Reveal>
          ...
          <div className="grid lg:grid-cols-2 gap-lg items-center">
            <Reveal>
              ...
              <p className="body-md text-secondary leading-relaxed font-sans">
                Process engineering requires constant monitoring. Our design circle connects live
                telemetry inputs to virtual solver models, creating a continuous loop of
                verification, tuning, and emission adjustments.
              </p>
            </Reveal>
