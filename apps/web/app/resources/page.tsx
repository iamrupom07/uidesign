...
export default function ResourcesPage() {
  ...
  const whitepapers = [
    {
      title: "Alternative Fuels Flame Optimization",
      desc: "Advanced combustion diagnostics under alternative fuel substitution rates up to 85%.",
    },
    {
      title: "Reverse Engineering Coordinate Verification",
      desc: "Tolerances, point-cloud noise filters, and FEA validations for brownfield retrofits.",
    },
  ];

  const guides = [
    {
      title: "Control Valve Sizing Guides",
      desc: "Detailed step-by-step calculations for gas, vapor, and liquid lines under ASME bounds.",
    },
    {
      title: "Burner Swirl Design Formulas",
      desc: "Calculate swirl index numbers and momentum profiles for optimized flame lengths.",
    },
  ];

  const articles = [
    {
      title: "Water Hammer Transient Auditing",
      desc: "Minimizing surge risks in piping systems through transient flow dynamics reviews.",
    },
    {
      title: "Cement Kiln Heat Transfer Reviews",
      desc: "Reducing thermal losses through refractory thickness calibrations and shell stress audits.",
    },
  ];

  const insights = [
    {
      title: "Alternative Fuel Trends in Cement Plants",
      desc: "Analyzing how changes in environmental regulations drive alternative fuel use in cement kilns.",
    },
    {
      title: "3D Scanner Tech Updates",
      desc: "Reviewing how high-definition coordinate scanning changes spatial layout designs.",
    },
  ];
  ...
  const webinars = [
    ...
    {
      title: "Transient Surge Analysis in Chemical Pipes",
      date: "September 8, 2026 at 2:00 PM CST",
    },
  ];
  ...
  const faqs = [
    {
      q: "What solvers do you use for process flow simulations?",
      a: "We primarily utilize ANSYS Fluent for complex, multi-phase CFD, and HYSYS for steady-state/dynamic process flowsheet mass balances.",
    },
    {
      q: "Can you reverse-engineer as-built plants from laser scans?",
      a: "Yes. We deploy high-resolution scanners to generate millimeter-accurate coordinate point clouds, reconstruct CAD models, and verify tolerances.",
    },
    {
      q: "Do your designs comply with standard engineering guidelines?",
      a: "Absolutely. All mechanical drafts and stress analyses comply with ASME Section VIII, API, and local environmental standards.",
    },
  ];
      ...
      <main className="bg-background min-h-screen blueprint-mesh py-24 space-y-24">
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          <Reveal>
            ...
            <p className="body-md text-secondary mt-4 max-w-2xl">
              Access calculations, publications, guides, and corporate profiles compiled by
              MacProtec&apos;s process engineers.
            </p>
          </Reveal>
        </section>
            ...
            {blogs.map((item) => (
              <RevealItem key={item.title}>
                <div className="card bg-white h-full flex flex-col justify-between">
                  <div>
                    <h3 className="font-display font-extrabold text-sm uppercase text-foreground mb-3">
                      {item.title}
                    </h3>
                  ...
                  <Link
                    ...
                    className="font-mono text-[9px] text-primary font-bold uppercase mt-6 tracking-widest hover:text-rose-700"
                  >
                    Read Article →
                  </Link>
                </div>
          ...
          <RevealGroup className="grid md:grid-cols-2 gap-lg" stagger={0.08}>
            {brochures.map((item) => (
              <RevealItem key={item.title}>
                <div className="card bg-white h-full flex flex-col justify-between">
                  <div>
                    <h3 className="font-display font-extrabold text-sm uppercase text-foreground mb-2">
                      {item.title}
                    </h3>
              ...
              <RevealItem key={item.title}>
                <div className="card bg-white h-full flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="font-display font-extrabold text-sm uppercase text-foreground">
                      {item.title}
                    </h3>
                  </div>
                  <Link
              ...
              <RevealItem key={item.title}>
                <div className="card bg-white h-full flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-xs font-mono text-emerald-600 font-bold uppercase">
                      {item.date}
                    </p>
                  </div>
                  <Link
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 border-t border-border pt-20">
          <Reveal className="mb-8">
            ...
            <p className="text-xs text-secondary mt-2 max-w-xl">
              Calculate convective and radiative heat loss based on kiln dimensions and average
              shell temperatures. Estimate cost savings using custom refractory alignments.
            </p>
          </Reveal>
            ...
            <Reveal className="lg:col-span-2">
              <div className="bg-white border border-border p-8 relative h-full flex flex-col justify-between">
                ...
                <div className="mt-8 pt-6 border-t border-border font-mono text-[10px] text-slate-500 uppercase">
                  ASSUMPTIONS: Ambient Temp = 25°C · Operating Hours = 8000 hr/yr · Emissivity =
                  0.90
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.08}>
              <div className="card relative h-full bg-white flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-4 font-mono text-xs text-secondary border-b border-border pb-4 mb-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-foreground">
                        {Math.round(qTotal / 1000)} kW
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>ANNUAL LOSS:</span>
                      <span className="font-bold text-foreground">
                        {Math.round(gjPerYear).toLocaleString()} GJ/yr
                      </span>
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="font-display font-extrabold text-xl text-emerald-600">
                      ...
                      <span className="text-xs font-mono font-medium text-slate-500">/ yr</span>
                    </div>
                  </div>
                </div>
                ...
                <button
                  onClick={() =>
                    alert(
                      `Calculations saved. ROI report generated for ${Math.round(projectedSavings).toLocaleString()}/yr savings.`
                    )
                  }
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 border-t border-border pt-20">
          <Reveal>
            ...
            <h2 className="text-2xl font-display font-extrabold uppercase text-foreground mb-4">
              Subscribe to Technical Logs
            </h2>
            <p className="text-xs text-secondary leading-relaxed font-sans max-w-xl mb-6">
              Stay updated with alternative fuel reviews, burner audits, and 3D laser-scanning case
              dossiers. Compiles once a month. No spam.
            </p>
            ...
            >
              ...
              <Magnetic strength={0.05}>
                <button type="submit" className="button-primary px-6 py-3 text-xs uppercase">
