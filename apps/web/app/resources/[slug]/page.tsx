          ...
          <Reveal delay={0.08}>
            <div className="card relative mb-12">
              <p className="body-md text-secondary leading-relaxed">
                Full research publication, flow calculations, and detailed process guidelines for{" "}
                <strong>{title}</strong>. This dossier details flow simulation formulas, combustion
                thermodynamics, 3D laser-scanning coordinate verification thresholds, and
                engineering standards guidelines to support plant operations.
              </p>
            </div>
          </Reveal>
            ...
            <div className="grid md:grid-cols-2 gap-lg">
              <div className="bg-white border border-border p-6 rounded-none relative">
                ...
                <ul className="space-y-3.5 font-mono text-[10px] text-secondary">
                  <li>
                    <span className="text-primary font-bold mr-1.5">//</span> CLASSIFICATION:
                    Technical Guide
                  </li>
                  <li>
                    <span className="text-primary font-bold mr-1.5">//</span> STANDARDS: ASME SEC
                    VIII / API guides
                  </li>
                  <li>
                    <span className="text-primary font-bold mr-1.5">//</span> COMPILER: MACPROTEC
                    Engineering Board
                  </li>
                  <li>
                    <span className="text-primary font-bold mr-1.5">//</span> REGISTRY:
                    USA-TX-HOU-2026
                  </li>
                </ul>
              </div>
