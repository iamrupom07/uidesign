...
export default function IndustryDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const industriesData: Record<string, IndustryContent> = {
    "cement-plants": {
      title: "Cement Plants",
      subtitle: "Maximize pyroprocessing thermal efficiency, increase alternative fuel substitutions, and reduce clinker cooler bottlenecks.",
      challenges: [
        {
      ...
      workflowDesc: "Every thermal audit follows our validated steps to ensure clinker output goals are met.",
      workflowSteps: [
        { step: "Phase 01", label: "Sensor Audit", desc: "Compile actual plant SCADA logs, fuel chemistry datasets, and pressure coordinates." },
        { step: "Phase 02", label: "CFD Thermal Flow", desc: "Construct multi-phase simulation meshes to profile internal velocity fields." },
        { step: "Phase 03", label: "Burner Alignment", desc: "Verify nozzle swirl indexes and optimize flame shape lengths." },
        { step: "Phase 04", label: "Continuous SLA", desc: "Deploy real-time dashboard telemetry logs to monitor sensor drift." },
      ],
    ...
    "cement-terminals": {
      ...
      subtitle: "Optimize pneumatic conveyor lines, eliminate pipe blockages, and speed up ship unloading rates.",
      challenges: [
        {
      ...
      workflowDesc: "Improving material transfer flow rates using validated fluid dynamics calculations.",
      workflowSteps: [
        { step: "01", label: "Line Audit", desc: "Audit blower curves, pipe routing configurations, and material parameters." },
        { step: "02", label: "Pneumatic CFD", desc: "Model gas-solid phase interactions using Eulerian solvers." },
        { step: "03", label: "Retrofit Drafts", desc: "Prepare detailed piping coordinates and clash check lists." },
  ...
  const defaultData: IndustryContent = {
    ...
    subtitle: "Process engineering, thermal auditing, and digital twin consulting customized for industrial sectors.",
    challenges: [
      {
    ...
    workflowSteps: [
      { step: "Phase 1", label: "Data Capture", desc: "Collect actual sensor values, piping geometry drafts, and parameters." },
      { step: "Phase 2", label: "Modeling & CFD", desc: "Construct flowsheet simulations and thermal grid meshes." },
      { step: "Phase 3", label: "Tolerances Check", desc: "Run structural stress and clash-detection audits." },
    ...
    <>
      ...
      <main className="bg-background min-h-screen blueprint-mesh space-y-24 pt-24 pb-20">
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          ...
          <div className="absolute top-10 left-10 font-mono text-[8px] text-slate-400">DRAFTING / INDUSTRY REPORT</div>
          <div className="absolute bottom-10 right-10 font-mono text-[8px] text-slate-400">SHEET [IND-01]</div>
          ...
          <div className="grid lg:grid-cols-2 gap-lg items-center">
            ...
            <Reveal>
              ...
              <p className="body-md text-secondary leading-relaxed font-sans">
                Our plant analytics dashboard integrates live SCADA variables directly with virtual simulation engines. This creates a continuous telemetry loop of diagnostics, alarms validation, and emission corrections.
              </p>
            </Reveal>
            ...
            <Reveal delay={0.12}>
              <div className="relative w-72 h-72 sm:w-96 sm:h-96 mx-auto flex items-center justify-center border border-border bg-white rounded-full p-4 overflow-hidden">
                ...
                <div className="absolute top-6 left-1/2 -translate-x-1/2 w-16 h-16 sm:w-20 sm:h-20 bg-white border border-border flex flex-col items-center justify-center text-center p-1 rounded-full shadow-sm hover:border-primary/50 transition-colors">
                  ...
                  <span className="font-display font-extrabold text-[8px] uppercase text-foreground mt-0.5">AUDIT</span>
                </div>
                ...
                <div className="absolute left-6 top-1/2 -translate-y-1/2 w-16 h-16 sm:w-20 sm:h-20 bg-white border border-border flex flex-col items-center justify-center text-center p-1 rounded-full shadow-sm hover:border-primary/50 transition-colors">
                  ...
                  <span className="font-display font-extrabold text-[8px] uppercase text-foreground mt-0.5">TUNE</span>
                </div>
              </div>
            </Reveal>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-lg">
            ...
            <Reveal>
              ...
              <p className="text-xs text-secondary leading-relaxed font-sans mb-6">
                Our process engineers design, verify, and validate structural layouts, thermal zones, and material feeds to target emission decreases.
              </p>
            ...
            <RevealItem>
              <div className="card bg-white border border-border p-6 h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-secondary leading-relaxed font-sans">
                    Combustion profiles and flame heat balances under alternative fuel substitutions.
                  </p>
                </div>
