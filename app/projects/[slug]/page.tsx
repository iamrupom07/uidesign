          ...
          <Reveal delay={0.08}>
            <div className="card relative mb-12">
              <p className="body-md text-secondary leading-relaxed">
                Project summary, client goals, mechanical designs, and flow simulation parameters for <strong>{title}</strong>. MacProtec applied CFD, FEA, and laser scanning workflows to bypass on-site trial periods, troubleshoot thermal states, and verify tolerances before mechanical assembly.
              </p>
            </div>
          </Reveal>
            ...
            <div className="grid md:grid-cols-2 gap-lg">
              <div className="bg-white border border-border p-6 rounded-none relative">
                ...
                <ul className="space-y-3.5 font-mono text-[10px] text-secondary">
                  <li><span className="text-primary font-bold mr-1.5">//</span> SOLVER: ANSYS Fluent multi-phase thermal</li>
                  <li><span className="text-primary font-bold mr-1.5">//</span> SCANNING: 3D laser scanner point clouds</li>
                  <li><span className="text-primary font-bold mr-1.5">//</span> MODELING: Autodesk Plant 3D coordinate checks</li>
                  <li><span className="text-primary font-bold mr-1.5">//</span> METRICS: SCADA dashboard telemetry logs</li>
                </ul>
              </div>
