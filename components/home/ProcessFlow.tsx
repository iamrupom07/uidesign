  ...
  const steps = [
    {
      ...
      description: "Perform detailed plant process audits, energy assessments, and 3D laser scanning scans to identify operational bottlenecks.",
    },
    {
      step: "STEP 02",
      title: "Simulate & Design",
      description: "Develop FEED engineering and basic designs, validating flow and thermal states using advanced CFD and FEA simulation solvers.",
    },
    {
      step: "STEP 03",
      title: "Commission & Integrate",
      description: "Integrate control systems, handle instrumentation commissioning, and optimize equipment performance on-site.",
    },
    {
      step: "STEP 04",
      title: "Predict & Monitor",
      description: "Deploy digital twin dashboards and AI-based predictive maintenance monitoring to track plant KPIs in real time.",
    },
  ];
        ...
        <div>
          <Reveal>
            ...
            <p className="body-md text-secondary max-w-md mb-8">
              A structured, transparent engineering process that keeps heavy-process plants secure, stable, and running at maximum thermal and material efficiency.
            </p>
          </Reveal>
